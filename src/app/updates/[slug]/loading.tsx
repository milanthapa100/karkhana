...
export default function Loading() {
  ...
  return (
    <div className="mx-auto max-w-7xl" aria-busy="true" aria-label="Loading article">
      <div className="mb-6">
        <Skeleton className="h-4 w-40" />
      </div>

      <div className="mt-6 lg:grid lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-8 xl:gap-10">
